    ...
    public partial class ForgetPassword : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblmsg.Text = "Invalid UserName "+ Environment.NewLine +" and Security question ,Answer";
        ...
        private void SendPasswordtoEmail(DAUsers usrs)
        {
            ...
            mail.Body = "Hello " + usrs.Name + Environment.NewLine + "Your Login password:" + usrs.Password + Environment.NewLine +"Click here go to Login Page"+"http://localhost:1033/Login.aspx";
